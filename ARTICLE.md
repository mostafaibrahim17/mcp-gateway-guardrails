...
- [The companion repo](https://github.com/mostafaibrahim17/mcp-gateway-guardrails): the full stack from this post. Build the plugin, `docker compose up`, run the client.
